...
<head>
    ...
    <center><h1 class="sub-header">Laporan Data Anggota</h1></center>
</head>

<body>
<div class="card-body">
  <form class="form-horizontal" role="form" enctype="multipart/form-data" action="laporan/laporan_anggotaproses.php" method="POST">
